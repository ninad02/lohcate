...
public class ClusteringParams {
	...
	protected InputParameterDouble mDeletionThreshold        = new InputParameterDouble(1.8 /*1.15*/, "DeletionThreshold",        JSAP.NO_SHORTFLAG, "delThresh", "Copy_Number_Threshold_for_Deletion");
